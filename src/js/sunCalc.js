...
let updateMoon = () => {
  ...
  moonIMG.src = "./assets/img/moon/jpg/" + parseInt((SunCalc.getMoonIllumination(timeUp).phase * 35) + 1) + ".jpg";
};

chronoSphere.addInitFunction(sunStart);
