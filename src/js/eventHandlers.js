...
document
  ...
  .addEventListener("click", () => chronoSphere.resetToPresent(), false);

//Change time
document
  .getElementsByClassName("yearB")[0]
  .addEventListener("click", () => chronoSphere.changeTime(-1, "years"), false);
...
document
  ...
  .addEventListener("click", () => chronoSphere.changeTime(-1, "days"), false);

document
  .getElementsByClassName("hourB")[0]
  .addEventListener("click", () => chronoSphere.changeTime(-1, "hours"), false);
...
document
  ...
  .addEventListener("click", () => chronoSphere.changeTime(1, "months"), false);
